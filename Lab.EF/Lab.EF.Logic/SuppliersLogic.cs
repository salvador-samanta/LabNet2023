...
namespace Lab.EF.Logic
{
    public class SuppliersLogic : BaseLogic, IABMLogic<Suppliers>
    {
        ...
        public async Task<int> checkExist(int id)
        {
            var checkId = await context.Suppliers.Where(e => e.SupplierID == id).CountAsync();
            return checkId;
        }
        ...
        public SuppliersLogic(NorthwindContext context = null)
        {
